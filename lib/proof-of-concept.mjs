...
import { methods, release } from './intercept-object';

const new_t = methods(intercept_log1)(t)
...
const [ next_receiver, original_t ] = release(new_t)
console.log(`next receiver:`)
console.group()
console.log(next_receiver)
console.groupEnd()
console.log(`released object:`)
console.group()
console.log(original_t)
console.groupEnd()
console.log(`original object:`)
console.group()
console.log(t)
console.groupEnd()
console.log(`released object === original:`)
console.group()
console.log(original_t === t)
console.groupEnd()
