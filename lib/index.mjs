...
import * as intercept from './method-interceptor'
...
/* NOTE(jordan): the only way to not recur infinitely is to expand
 * descriptor objects into comparable pairs of values. Otherwise, we get
 * the properties for the descriptor objects, and then the properties for
...
export { verisimilitude, asserts, sisyphus }
